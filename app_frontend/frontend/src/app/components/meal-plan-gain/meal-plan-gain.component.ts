...
@Component({
  selector: 'app-meal-plan-gain',
  templateUrl: './meal-plan-gain.component.html',
  styleUrls: ['./meal-plan-gain.component.css']
})
export class MealPlanGainComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.titlseService.setTitle('Here is your plan to gain weight')
    this.getFoods();
    this.getExercises();
